(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("/Users/shyan/Gatsby/tutorial-part-three/node_modules/@reach/router/index.js"), require("fs"), require("/Users/shyan/Gatsby/tutorial-part-three/node_modules/lodash/lodash.js"), require("path"), require("react"), require("react-dom/server"));
	else if(typeof define === 'function' && define.amd)
		define("lib", ["/Users/shyan/Gatsby/tutorial-part-three/node_modules/@reach/router/index.js", "fs", "/Users/shyan/Gatsby/tutorial-part-three/node_modules/lodash/lodash.js", "path", "react", "react-dom/server"], factory);
	else if(typeof exports === 'object')
		exports["lib"] = factory(require("/Users/shyan/Gatsby/tutorial-part-three/node_modules/@reach/router/index.js"), require("fs"), require("/Users/shyan/Gatsby/tutorial-part-three/node_modules/lodash/lodash.js"), require("path"), require("react"), require("react-dom/server"));
	else
		root["lib"] = factory(root["/Users/shyan/Gatsby/tutorial-part-three/node_modules/@reach/router/index.js"], root["fs"], root["/Users/shyan/Gatsby/tutorial-part-three/node_modules/lodash/lodash.js"], root["path"], root["react"], root["react-dom/server"]);
...
const preferDefault=m=>m&&m.default||m;exports.components={"component---src-pages-about-js":hot(preferDefault(__webpack_require__(/*! ./src/pages/about.js */ "./src/pages/about.js"))),"component---src-pages-blog-detail-js":hot(preferDefault(__webpack_require__(/*! ./src/pages/blog-Detail.js */ "./src/pages/blog-Detail.js"))),"component---src-pages-contact-js":hot(preferDefault(__webpack_require__(/*! ./src/pages/contact.js */ "./src/pages/contact.js"))),"component---src-pages-index-js":hot(preferDefault(__webpack_require__(/*! ./src/pages/index.js */ "./src/pages/index.js"))),"component---src-pages-main-js":hot(preferDefault(__webpack_require__(/*! ./src/pages/main.js */ "./src/pages/main.js")))};
...
/* harmony import */ var react_lifecycles_compat__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! react-lifecycles-compat */ "./.cache/react-lifecycles-compat.js");
/* harmony import */ var react_lifecycles_compat__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(react_lifecycles_compat__WEBPACK_IMPORTED_MODULE_10__);
...
/* harmony import */ var react_lifecycles_compat__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! react-lifecycles-compat */ "./.cache/react-lifecycles-compat.js");
/* harmony import */ var react_lifecycles_compat__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(react_lifecycles_compat__WEBPACK_IMPORTED_MODULE_9__);
  ...
  babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4___default()(TweenOne, [{
    ...
    value: function render() {
      ...
      if (!component && typeof children !== 'string') {
        ...
        return react__WEBPACK_IMPORTED_MODULE_6___default.a.cloneElement(children, { style: newStyle, ref: refFunc, className: newClassName });
      }
      return react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(component, babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
        ref: refFunc
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.setDefault = function (props) {
    ...
    _this3.startTime = _ticker__WEBPACK_IMPORTED_MODULE_12__["default"].time;
  };
  ...
  this.start = function () {
    ...
    if (props.animation && Object.keys(props.animation).length) {
      ...
      _this3.tween = new _Tween__WEBPACK_IMPORTED_MODULE_11__["default"](_this3.dom, props.animation, props.attr);
      _this3.tween.reverse = _this3.reverse;
      // 预先注册 raf, 初始动画数值。
      _this3.raf();
      // 开始动画
  ...
  this.play = function () {
    ...
    _this3.rafID = _ticker__WEBPACK_IMPORTED_MODULE_12__["default"].add(_this3.raf);
  };
  ...
  this.frame = function () {
    ...
    var moment = _ticker__WEBPACK_IMPORTED_MODULE_12__["default"].time - _this3.startTime + _this3.startMoment;
    if (_this3.reverse) {
      moment = (_this3.startMoment || 0) - (_ticker__WEBPACK_IMPORTED_MODULE_12__["default"].time - _this3.startTime);
    }
  ...
  this.cancelRequestAnimationFrame = function () {
    _ticker__WEBPACK_IMPORTED_MODULE_12__["default"].clear(_this3.rafID);
    _this3.rafID = -1;
  };
};
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! prop-types */ "./node_modules/prop-types/index.js");
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var react_lifecycles_compat__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! react-lifecycles-compat */ "./.cache/react-lifecycles-compat.js");
...
/* harmony import */ var _carousel_module_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./carousel.module.css */ "./src/components/carousel.module.css");
...
class Carousel3d extends react__WEBPACK_IMPORTED_MODULE_2___default.a.PureComponent{constructor(_props){super(_props);this.onTouchStart=e=>{if(e.touches&&e.touches.length>1||this.length<=1){return;}this.startX=e.pageX||e.touches[0].pageX;this.startRotate=Math.round(this.state.rotate/this.angle)*this.angle;// 偏移修复;
};this.onTouchMove=e=>{if(e.touches&&e.touches.length>1||this.length<=1||!this.startX){return;}const x=e.pageX||e.touches[0].pageX;const differ=(x-this.startX)*this.props.moveRange;// 幅度加大；
const rotate=this.startRotate+differ/this.w*this.angle;const r=(Math.abs(Math.ceil(this.state.rotate/360))*360-rotate)%360;const current=Math.round(r/this.angle)%this.length;this.setState({rotate,current,transition:'none'},()=>{this.props.onChange({current,rotate,eventType:'move'});});};this.onTouchEnd=e=>{if(e.changedTouches&&e.changedTouches.length>1||this.length<=1||!this.startX){return;}const x=e.pageX||e.changedTouches[0].pageX;const differ=x-this.startX;const{current,rotate}=this.state;const n=differ>0?1:-1;const newRotate=this.startRotate+n*this.angle*Math.round(Math.abs((rotate-this.startRotate)/this.angle));this.setState({rotate:newRotate,transition:`transform ${this.props.duration} ${this.props.ease}`},()=>{this.startX=null;this.props.onChange({current,rotate:newRotate,eventType:'end'});});};this.setLengthAndAngle=props=>{this.length=react__WEBPACK_IMPORTED_MODULE_2___default.a.Children.toArray(props.children).length;this.length=this.length>props.childMaxLength?props.childMaxLength:this.length;this.angle=360/this.length;};this.getAnimStyle=(n,length)=>{const{opacityBasics,opacityDecline,blurIncrease}=this.props;const center=length/2;const i=n>center?center*2-n:n;let opacity=1-((i-1)*opacityDecline+opacityBasics*(n?1:0));opacity=opacity<0.1?0.1:opacity;const d={opacity};if(blurIncrease){d.filter=`blur(${i*blurIncrease}px)`;}return d;};this.getChildrenToRender=children=>{const{childMaxLength,z}=this.props;const newChildren=react__WEBPACK_IMPORTED_MODULE_2___default.a.Children.toArray(children);const length=newChildren.length;const zDpr=z*dpr;return newChildren.map((item,i)=>{if(i>=childMaxLength){return null;}const transform=`rotateY(${this.angle*i}deg) translateZ(${zDpr}px) rotateY(-${this.angle*i}deg) `;const animStyle=this.getAnimStyle(Math.abs(this.state.current-i),length>childMaxLength?childMaxLength:length);const style={transform// opacity: animStyle.opacity, 留坑，preserve-3d 不可以与 opacity 同时使用，排查了一下午
};return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div",{className:_carousel_module_css__WEBPACK_IMPORTED_MODULE_1___default.a.itemWrapper,key:item.key,style:style},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div",{className:_carousel_module_css__WEBPACK_IMPORTED_MODULE_1___default.a.rotateLayer,style:{transform:`rotateY(${-this.state.rotate}deg)`,transition:this.state.transition}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div",{className:_carousel_module_css__WEBPACK_IMPORTED_MODULE_1___default.a.bgAndBlurLayer,style:{...animStyle}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div",{className:_carousel_module_css__WEBPACK_IMPORTED_MODULE_1___default.a.contentLayer,style:{opacity:this.state.current===i?1:0}},item))));});};this.setLengthAndAngle(_props);this.state={rotate:-_props.current*this.angle,current:_props.current,transition:'none'};}componentDidMount(){this.w=document.body.clientWidth;window.addEventListener('mouseup',this.onTouchEnd);}componentDidUpdate(prevProps){if(prevProps!==this.props){const{current,children}=this.props;if(current!==this.state.current&&current!==prevProps.current||react__WEBPACK_IMPORTED_MODULE_2___default.a.Children.toArray(children).length!==react__WEBPACK_IMPORTED_MODULE_2___default.a.Children.toArray(prevProps.children).length){this.setLengthAndAngle(this.props);// eslint-disable-next-line
this.setState({current:this.props.current,rotate:-this.props.current*this.angle,transition:`transform ${this.props.duration} ${this.props.ease}`});}}}render(){const{onChange,...props}=this.props;const{children,tilt,style,z,perspective}=props;const zDpr=z*dpr;const perspectiveDpr=perspective*dpr;const childrenToRender=this.getChildrenToRender(children,perspective);['tilt','duration','ease','blurIncrease','opacityDecline','opacityBasics','moveRange','childMaxLength','perspective','z','current'].forEach(k=>delete props[k]);return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div",Object.assign({},props,{onTouchStart:this.onTouchStart,onMouseDown:this.onTouchStart,onTouchMove:this.onTouchMove,onMouseMove:this.onTouchMove,onTouchEnd:this.onTouchEnd,onMouseUp:this.onTouchEnd}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div",{className:_carousel_module_css__WEBPACK_IMPORTED_MODULE_1___default.a.carouselWrapper},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div",{className:_carousel_module_css__WEBPACK_IMPORTED_MODULE_1___default.a.carousel,style:{...style,perspective:perspectiveDpr,transform:`translateY(-${tilt}) scale(${(perspectiveDpr-zDpr)/perspectiveDpr})`}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div",{className:_carousel_module_css__WEBPACK_IMPORTED_MODULE_1___default.a.carouselContent,style:{transform:`translateY(${tilt}) rotateY(${this.state.rotate}deg)`,transition:this.state.transition}},childrenToRender))));}}Carousel3d.propTypes={children:prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.any,style:prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.object,className:prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.string,onChange:prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.func,tilt:prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.string,duration:prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.string,ease:prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.string,blurIncrease:prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.number,opacityDecline:prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.number,opacityBasics:prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.number,moveRange:prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.number,childMaxLength:prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.number,perspective:prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.number,z:prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.number,current:prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.number};Carousel3d.defaultProps={onChange:()=>{},tilt:'5rem',duration:'.45s',ease:'cubic-bezier(0.215, 0.61, 0.355, 1)',blurIncrease:8,opacityDecline:0.1,opacityBasics:0.5,moveRange:2,childMaxLength:6,perspective:2800,z:800,current:0};/* harmony default export */ __webpack_exports__["default"] = (Carousel3d);
...
module.exports = {
	"carouselDemoWrapper": "carousel-module--carouselDemoWrapper--2F2Nb",
	"carouselDemo": "carousel-module--carouselDemo--37e9P",
	"carouselWrapper": "carousel-module--carouselWrapper--fXMLX",
	"carousel": "carousel-module--carousel--AY-0M",
	"carouselContent": "carousel-module--carouselContent--2Cl51",
	"itemWrapper": "carousel-module--itemWrapper--140nh",
	"rotateLayer": "carousel-module--rotateLayer--51Nv_",
	"bgAndBlurLayer": "carousel-module--bgAndBlurLayer--11UAO",
	"contentLayer": "carousel-module--contentLayer--FmUSJ",
	"imgWrapper": "carousel-module--imgWrapper--3uc_E"
};
...
const ListLink=props=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li",{style:{display:`inline-block`,marginRight:`1rem`}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__["Link"],{to:props.to},props.children));/* harmony default export */ __webpack_exports__["default"] = (({children})=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{style:{margin:`3rem auto`,maxWidth:'85%',padding:`0 1rem`,position:'relative'}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("header",{style:{marginBottom:`1.5rem`}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__["Link"],{to:"/main/",style:{textShadow:`none`,backgroundImage:`none`,display:'flex',alignItems:'center',width:'20%'}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img",{className:_layout_module_css__WEBPACK_IMPORTED_MODULE_2___default.a.avatarsImg,src:"http://chuantu.xyz/t6/741/1605176351x-1404755629.jpg"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span",{className:_layout_module_css__WEBPACK_IMPORTED_MODULE_2___default.a.name},"A Cool Jay")),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__["Link"],{to:"/",className:_layout_module_css__WEBPACK_IMPORTED_MODULE_2___default.a.home},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img",{src:"/assets/home.svg"}))),children));
...
module.exports = {
	"avatarsImg": "layout-module--avatarsImg--3OGVD",
	"name": "layout-module--name--3udZH",
	"home": "layout-module--home--cVJ9O"
};
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_layout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/layout */ "./src/components/layout.js");
/* harmony import */ var rc_queue_anim__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rc-queue-anim */ "./node_modules/rc-queue-anim/es/index.js");
// import detailsStyles from "./details.module.css"
/* harmony default export */ __webpack_exports__["default"] = (({location})=>{console.log("***",location);Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(()=>{document.getElementById("detailBody").innerHTML=location.state.node.html;});return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_layout__WEBPACK_IMPORTED_MODULE_1__["default"],null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(rc_queue_anim__WEBPACK_IMPORTED_MODULE_2__["default"],{key:"queueAnim",delay:2000,duration:2000,opacity:[1,0]},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",null,location.state.node.frontmatter.title),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{id:"detailBody"})));});
...
/* harmony default export */ __webpack_exports__["default"] = (()=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(rc_queue_anim__WEBPACK_IMPORTED_MODULE_3__["default"],{delay:500,duration:2000,opacity:[1,0]},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:_index_module_css__WEBPACK_IMPORTED_MODULE_2___default.a.container,key:"demo1"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:_index_module_css__WEBPACK_IMPORTED_MODULE_2___default.a.avatars},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img",{className:_index_module_css__WEBPACK_IMPORTED_MODULE_2___default.a.avatarsImg,src:"http://chuantu.xyz/t6/741/1605176351x-1404755629.jpg"})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:_index_module_css__WEBPACK_IMPORTED_MODULE_2___default.a.nickname},"\u4E00\u53EA\u5927\u5927\u7684\u6770\u54E5")),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{style:{width:'50%',paddingLeft:'100px'}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:_index_module_css__WEBPACK_IMPORTED_MODULE_2___default.a.motto},"\u4EBA\u751F\u5728\u4E16\uFF0C\u4F60\u53EA\u8981\u77E5\u9053\u4E24\u4EF6\u4E8B\u3002\u8FD9\u4E16\u4E0A\u7EDD\u5BF9\u5B58\u5728\u4E0D\u9700\u8981\u8BFB\u4E66\u4E5F\u5F88\u806A\u660E\uFF0C\u4E0D\u9700\u8981\u52AA\u529B\u4E5F\u8FC7\u5F97\u5F88\u597D\u7684\u4EBA\u3002\u90A3\u4E2A\u4EBA\u7EDD\u5BF9\u4E0D\u662F\u4F60\u3002\u7136\u540E\uFF0C\u4F60\u8981\u505A\u7684\u5C31\u662F\u4E50\u89C2\u5E76\u575A\u6301\u52AA\u529B\uFF0C\u8BA9\u6BCF\u4E00\u5929\u7684\u81EA\u5DF1\u66F4\u51FA\u8272\u4E00\u70B9\u3002"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{style:{paddingTop:'24px'}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(gatsby__WEBPACK_IMPORTED_MODULE_4__["Link"],{to:"/main"},"\u8FDB\u5165\u4E3B\u9875"))))));
...
module.exports = {
	"container": "index-module--container--Eqp4Q",
	"avatars": "index-module--avatars--1q9qS",
	"avatarsImg": "index-module--avatarsImg--2C-1G",
	"nickname": "index-module--nickname--1Li-Z",
	"motto": "index-module--motto--2HzOK"
};
...
/* harmony import */ var _main_module_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./main.module.css */ "./src/pages/main.module.css");
...
/* harmony import */ var gatsby__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! gatsby */ "./.cache/gatsby-browser-entry.js");
/* harmony import */ var rc_queue_anim__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rc-queue-anim */ "./node_modules/rc-queue-anim/es/index.js");
/* harmony default export */ __webpack_exports__["default"] = (({data})=>{//   const imgWrapper = [
...
//   });
// console.log("*******",data)
const children=data.allMarkdownRemark.edges.map((node,i)=>(console.log("*******",node),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{key:i.toString(),className:_main_module_css__WEBPACK_IMPORTED_MODULE_3___default.a.imgWrapper,style:{backgroundImage:`url(${node.node.frontmatter.mainImage})`},onClick:event=>{event.preventDefault();// TODO: do something with form values
Object(gatsby__WEBPACK_IMPORTED_MODULE_4__["navigate"])("/blog-Detail",{state:node});}})));return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_layout__WEBPACK_IMPORTED_MODULE_1__["default"],null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(rc_queue_anim__WEBPACK_IMPORTED_MODULE_5__["default"],{className:"demo-page",key:"page",type:"bottom"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1",{key:"title",className:_main_module_css__WEBPACK_IMPORTED_MODULE_3___default.a.motto},"Go big or go home"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{key:"carouse",className:_main_module_css__WEBPACK_IMPORTED_MODULE_3___default.a.carouselDemoWrapper},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_carousel__WEBPACK_IMPORTED_MODULE_2__["default"],{className:_main_module_css__WEBPACK_IMPORTED_MODULE_3___default.a.carouselDemo,childMaxLength:6},children)),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{key:"blog",className:_main_module_css__WEBPACK_IMPORTED_MODULE_3___default.a.blogContainer},data.allMarkdownRemark.edges.map(({node})=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(rc_queue_anim__WEBPACK_IMPORTED_MODULE_5__["default"],{key:"queueAnim"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{key:node.id,className:_main_module_css__WEBPACK_IMPORTED_MODULE_3___default.a.blogItem,onClick:event=>{event.preventDefault();// TODO: do something with form values
Object(gatsby__WEBPACK_IMPORTED_MODULE_4__["navigate"])("/blog-Detail",{state:{node}});}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:_main_module_css__WEBPACK_IMPORTED_MODULE_3___default.a.blogLeft},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img",{src:node.frontmatter.mainImage,className:_main_module_css__WEBPACK_IMPORTED_MODULE_3___default.a.mainImage})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:_main_module_css__WEBPACK_IMPORTED_MODULE_3___default.a.blogRight},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3",{className:_main_module_css__WEBPACK_IMPORTED_MODULE_3___default.a.blogTitle},node.frontmatter.title," ",/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span",null,"\u2014 ",node.frontmatter.date)),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p",{className:_main_module_css__WEBPACK_IMPORTED_MODULE_3___default.a.shortText},node.excerpt))))))));});const query="1534663236";

/***/ }),

/***/ "./src/pages/main.module.css":
/*!***********************************!*\
  !*** ./src/pages/main.module.css ***!
  \***********************************/
/*! no static exports found */
...
module.exports = {
	"motto": "main-module--motto--3PDJf",
	"blogContainer": "main-module--blogContainer--1umxl",
	"blogItem": "main-module--blogItem--3icZb",
	"blogLeft": "main-module--blogLeft--3ftMl",
	"mainImage": "main-module--mainImage--vfAIL",
	"blogRight": "main-module--blogRight--3Exm4",
	"blogTitle": "main-module--blogTitle---Av9x",
	"shortText": "main-module--shortText--3eXWY",
	"carouselDemoWrapper": "main-module--carouselDemoWrapper--3vRf0",
	"carouselDemo": "main-module--carouselDemo--1sJkQ",
	"carouselWrapper": "main-module--carouselWrapper--2YP9k",
	"carousel": "main-module--carousel--KV8of",
	"carouselContent": "main-module--carouselContent--2NXor",
	"itemWrapper": "main-module--itemWrapper--3xT70",
	"rotateLayer": "main-module--rotateLayer--XHj9_",
	"bgAndBlurLayer": "main-module--bgAndBlurLayer--3TMLZ",
	"contentLayer": "main-module--contentLayer--3t2re",
	"imgWrapper": "main-module--imgWrapper--3jIDe"
};
...
const typography=new typography__WEBPACK_IMPORTED_MODULE_0___default.a(typography_theme_fairy_gates__WEBPACK_IMPORTED_MODULE_1___default.a);const{scale,rhythm,options}=typography;/* harmony default export */ __webpack_exports__["default"] = (typography);

/***/ }),

/***/ "@reach/router":
/*!**********************************************************************************************!*\
  !*** external "/Users/shyan/Gatsby/tutorial-part-three/node_modules/@reach/router/index.js" ***!
  \**********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "lodash":
/*!****************************************************************************************!*\
  !*** external "/Users/shyan/Gatsby/tutorial-part-three/node_modules/lodash/lodash.js" ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
